...
## GPA Distribution by Placement Status
...
# Placement Rate by Stream(Course Specialization)
```{r}
...
ggplot(placed_students, aes(x = salary)) +
  ...
  theme_minimal()
```
**2. Salary by Stream (Undertaken Course)**
```{r}
...
**3. GPA, Experience and Placement Status**
